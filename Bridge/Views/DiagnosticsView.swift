        ...
        NavigationStack {
            List {
                ...
                Section("本地数据") {
                    ...
                    Text("评论完整性：\(store.commentIntegritySummary)")
                        .font(.caption)
                ...
                Section {
                    ...
                    Text("无效放置清理会删除缺失虚像、WorldMap 缺失、WorldMap 文件名无效、WorldMap 解码失败、WorldMap 缺少目标锚点或 transform 异常的放置，并清理相关评论。孤儿 WorldMap 清理只删除没有被任何放置引用的本地地图文件。")
                }
