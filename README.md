...
6. V5.9 红灵/白灵共用同一奇幻 shader：体内能量、主轮廓壳与低密度外层光晕分工渲染；主表面使用视线厚度吸收代替实体式方向高光，厚处沉入阴影、薄处透出魂光，并以厘米级以内的连续轮廓呼吸和稳定雾化噪声打散规则外缘。向上流动的内层魂流与连续孔隙进一步削弱透明塑料感，同时保留完整人体轮廓。120/48/0 分档 GPU 魂屑改为稀疏的纵向上升细迹，不再形成密集圆点；高／中画质另有无硬圆环的贴地魂雾，使脚部与场景形成低密度能量交换。白灵另有正常混合的深色对比轮廓，在明亮场景中也不会融入背景。
