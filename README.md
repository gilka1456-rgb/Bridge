...
- 支持灵体、幽灵、赛博、量子四种材质风格。
- 所有风格使用半透明内层与两层膨胀柔光外壳，包含菲涅尔边缘光、表面流动和脚部消散；赛博和量子额外保留扫描线效果。
...
3. 下一步是 V2 程序化四骨蒙皮，把标准人体可靠恢复到扫描姿势。
4. V3–V6 在同一人体资产上实现共享透明渲染内核、移动端 LOD，以及奇幻/赛博两套风格。
5. 持续保持扫描、媒体生命周期、本地数据迁移和旧渲染回退测试完整。
