...
6. V5.4 红灵/白灵共用同一奇幻 shader：连续体内能量与软轮廓壳承担主体可读性，180/72/0 分档的低对比 GPU 微粒只提供轻雾漂移，避免近看出现圆点、尖刺或重新暴露几何分段。
...
9. 当前预览已扩大到适合手机审查的全身构图，并按人体外轮廓补偿髋宽、收小头部，手掌、髋部、腿间分离及近距离材质均已完成一轮收敛；下一步进入 iPhone 真机验收。
