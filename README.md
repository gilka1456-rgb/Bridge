...
8. 两种风格共享同一人体、骨骼、深度、LOD 和质量架构；四张全身测试图已全部通过识别（单图轮廓质量 91%–97%，重建质量 90%）。弱帧不再让有效的正/背面与侧面腿部证据整体降级，LOD 预算也不再因少量三角形波动回退成旧火柴人。
9. 下一步是继续改善手部、腿间分离和近距离材质观感，再进入 iPhone 真机验收。
