...
| P0-5 | Save world map | Tap save after mapping is mapped/extending. | Save succeeds and placement appears under My Placements. Diagnostics record the WorldMap filename, anchor count, file size, mapping status, location availability, and heading. | |
